...
typedef enum e_orient{
	...
	left,
	up
}		e_orient; //todo-me user typedef must start with t_
...
t_quant_view	*qv_array;//todo-me global variables start with g_
...
void	create_quant_view_array(void);
...
void	go_step(t_map *map, t_point *cur_p, int step, int *i_prev_qv,
			 e_orient orient);
